...
from .views import index, delete_post, edit_comment, post_detail, edit_post, delete_comment, edit_profile, add_comment, create_post, category_posts, register, profile, edit_profile
